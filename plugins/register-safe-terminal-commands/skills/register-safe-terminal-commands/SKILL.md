...
For failure modes of `sync_safe_commands.py` (missing / malformed `settings.json`, backup-write errors, mid-write truncation, schema-version mismatch), load `${SKILL_DIR}/references/troubleshooting.md`.
